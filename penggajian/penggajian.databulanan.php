				...
				<th colspan="4">
					<table width="100%">
						<tr>
							<td width="12%">NIP</td>
							<td width="1%">:</td>
							<td width="27%"><?php echo $getnamapegawaidata->NIP_PEGAWAI;?></td>
							  
							<td width="12%">DEPARTEMEN</td>
							<td width="1%">:</td>
							<td width="27%"><?php echo $getnamapenggajian->NAMA_DEPARTEMEN;?></td>
							 
						</tr>
						<tr>
							<td width="12%">NAMA</td>
							<td width="1%">:</td>
							<td width="37%"><?php echo $getnamapegawaidata->NAMA_PEGAWAI;?></td>
							<td width="12%">JABATAN</td>
							<td width="1%">:</td>
							<td width="37%"><?php echo $getjabatan->NAMA_JABATAN;?></td>
		...
		<tbody>
			...
			<tr>
				<td colspan="2">
					<table width="100%">
						<tr>
							<td width="50%">Gaji Bulan Ini</td>
							<td width="50%">Rp.<?php echo number_format($getnamapegawaidata->GAJI_POKOK);?>,-</td>
						</tr>
						<?php
						...
						<tr>
							...
							<td width="50%">Rp.<?php echo number_format($getnamapegawaidata->NOMINAL_UMT * $jumlahmasuk);?>,-</td>
						</tr>
						<tr>
							<td width="50%">Lembur(<?php echo $totaljamlembur;?> Jam)</td>
							<td width="50%">Rp.<?php echo number_format($lembur);?>,-</td>
						</tr>
						<tr>
							<td width="50%">Penghargaan</td>
							<td width="50%">Rp.<?php echo number_format($getnamapegawaidata->PENGHARGAAN);?>,-</td>
						</tr>
				...
				<td colspan="2">
					<table width="100%">
						...
						<tr>
							<td width="50%">Total Kasbon</td>
							<td width="50%">Rp.<?php echo number_format($kasbon);?>,-</td>
						</tr> 
						<tr>
							<td width="50%">Total Pinjaman</td>
							<td width="50%">Rp.<?php echo number_format($nominalpinjaman);?>,-</td>
						</tr> 
						<tr>
							<td width="50%">Tabungan</td>
							<td width="50%">Rp.<?php echo number_format($getnamapegawaidata->TABUNGAN);?>,-</td>
						</tr>
						<tr>
							<td width="50%">Keterlambatan(<?php echo jmltelat($NIP,$BULAN,$TAHUN);?> Hari)</td>
							<td width="50%">Rp.<?php echo number_format($terlambat);?>,-</td>
						</tr>
					</table>
				</td>
			</tr>
		...
		<tfoot>
				...
				<th colspan="4">
					<table width="100%">
						<tr>
							...
							<td width="25%">Rp.<?php echo $total_penerimaan; ?>,-</td>
							<td width="25%">TOTAL POTONGAN</td>
							<td width="25%">Rp.<?php echo $total_potongan; ?></td>
						</tr>
			...
			<tr>
				<th colspan="2">
					<table width="100%">
						<tr>
							<td width="39%">TAKE HOME PAY</td>
							<td width="1%">:</td>
							<td width="40%">Rp.<?php echo number_format($takehomepayfix+$lembur); ?>,-</td>
						</tr>
					</table>
				</th>
				<th colspan="2">
					<table width="100%">
						<tr>
							<td width="39%">TOTAL TABUNGAN</td>
							<td width="1%">:</td>
							<td width="40%">Rp.<?php echo number_format($tb); ?>,-</td>
						</tr>
					</table>
				</th>
			</tr>
