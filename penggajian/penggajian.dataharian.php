<?php 
	...
	include("../panel/include/function_hitunggaji_harian.php");
	$BULAN=date('m');
	$TAHUN=date('Y');
	$DEPT="All";
	$NIP_PEGAWAIH=$NIP2;
				...
				<td colspan="2">
					<table width="100%">
						<tr>
							...
							<td width="50%">Rp.<?php echo number_format($totalgaji);?>,-</td>
						</tr>
						<?php
						...
						<tr>
							...
							<td width="50%">Rp.<?php echo number_format($totallembur);?>,-</td>
						</tr>
						<tr>
				...
				<th colspan="4">
					<table width="100%">
						<tr>
							...
							<td width="25%">Rp.<?php echo number_format($total_penerimaan); ?>,-</td>
				...
				<th colspan="2">
					<table width="100%">
						<tr>
							...
							<td width="1%">:</td>
							<td width="40%">Rp.<?php echo number_format($takehomepayfix); ?>,-</td>
						</tr>
					</table>
				</th>
				<th colspan="2">
