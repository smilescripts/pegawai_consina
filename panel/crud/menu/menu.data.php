        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<?php
						...
						$mastermenu=mysql_query("select * from rights_menu where ID < '11'  or ID='25' or ID='28' or ID='34' ");
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu " role="menu">
					<?php
						$mastermenu=mysql_query("select * from rights_menu where ID='12' or ID='27' ");
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu " role="menu">
					<?php
						$mastermenu=mysql_query("select * from rights_menu where ID = '13' or ID='26' or ID='29'");
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu " role="menu">
					<?php
						$mastermenu=mysql_query("select * from rights_menu where ID = '31' OR ID='32' ");
            ...
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu " role="menu">
					<?php
						$mastermenu=mysql_query("select * from rights_menu where ID >'15' and ID < 25 or ID='30' or ID='33'");
