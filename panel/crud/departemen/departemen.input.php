<?php
	...
	if(isset($_POST['hapus'])) {
		...
		$before=mysql_fetch_object(mysql_query("SELECT * FROM departemen where KODE_DEPARTEMEN='$KODE_DEPARTEMEN'"));
	
		if($KODE_DEPARTEMEN == 0) {
            mysql_query("INSERT INTO departemen VALUES(NULL,'$NAMA_DEPARTEMEN','0')");
			include "../../include/catat.php";
			$user=$_SESSION['KODE_PETUGAS'];
			$aksi="Melakukan tambah data departemen :".$NAMA_DEPARTEMEN."";
			catat($user,$aksi);
		} else {
            mysql_query("UPDATE departemen SET NAMA_DEPARTEMEN = '$NAMA_DEPARTEMEN'  WHERE KODE_DEPARTEMEN = '$KODE_DEPARTEMEN' ");
			include "../../include/catat.php";
			$user=$_SESSION['KODE_PETUGAS'];
			$aksi="Melakukan ubah data departemen ".$before->NAMA_DEPARTEMEN." Menjadi ".$NAMA_DEPARTEMEN."";
			catat($user,$aksi);
		}
    }
?>
