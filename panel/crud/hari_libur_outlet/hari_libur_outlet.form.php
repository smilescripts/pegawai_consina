<?php
    ...
    $data = mysql_fetch_array(mysql_query("
        SELECT * FROM hari_libur_outlet WHERE ID=".$id
    ));
...
<form class="form-horizontal hari_libur_outletForm" id="hari_libur_outletForm" action="crud/hari_libur_outlet/hari_libur_outlet.input.php" type="POST">
    ...
    $(document).ready(function() {
		...
		.on('success.form.fv', function(e) {
            ...
            $.ajax({
                ...
                data: $form.serialize(),
                success: function() {
                    $('#dialog-hari_libur_outlet').modal('hide');
                }
            });
        })
		.formValidation({
