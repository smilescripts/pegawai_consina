		...
		if($KODE_PEGAWAI == 0) {
            if($_FILES['FOTO_PEGAWAI']['name'][0]!=""){
				foreach($_FILES['FOTO_PEGAWAI']['name'] as $key => $value){
				   ...
				   ,'$CATATAN','$tmptunjanganlain2','$NOMINAL_LEMBUR','$OUTLET','$KODE_DIVISI','$LINE','$PENGAWAS')");
				...
				mysql_query("INSERT INTO pegawai 
					VALUES('','$NIP_PEGAWAI','$NAMA_PEGAWAI','$TEMPAT_LAHIR','$TANGGAL_LAHIR','$AGAMA','$STATUS_PERNIKAHAN','$JUMLAH_ANAK',
				   '$ALAMAT','$NOMOR_TELEPON','$KODE_JABATAN','$KODE_DEPARTEMEN','$GAJI_POKOK','$TANGGAL_MASUK','$TANGGAL_KELUAR',
				   '$STATUS_PEGAWAI','','$JENIS_KELAMIN','$EMAIL','$NO_REKENING','$STATE_ID','$NOMINAL_UMT','$TABUNGAN','$PENGHARGAAN','$CATATAN','$tmptunjanganlain2','$NOMINAL_LEMBUR','$OUTLET','$KODE_DIVISI','$LINE','$PENGAWAS')");	
					$ID_PEGAWAI=mysql_insert_id();
				   //$zk->setUser($ID_PEGAWAI,$ID_PEGAWAI, $NAMA_PEGAWAI, '', LEVEL_USER);			
				include "../../include/catat.php";
				$user=$_SESSION['KODE_PETUGAS'];
             ...
             if($_FILES['FOTO_PEGAWAI']['name'][0]!=""){
				foreach($_FILES['FOTO_PEGAWAI']['name'] as $key => $value){
					...
					, STATUS_PEGAWAI = '$STATUS_PEGAWAI', FOTO_PEGAWAI = '$new_name', JENIS_KELAMIN = '$JENIS_KELAMIN', EMAIL = '$EMAIL', NO_REKENING = '$NO_REKENING'
					, STATE_ID = '$STATE_ID', NOMINAL_UMT = '$NOMINAL_UMT', TABUNGAN = '$TABUNGAN', PENGHARGAAN = '$PENGHARGAAN', CATATAN = '$CATATAN', TUNJANGAN_LAIN = '$tmptunjanganlain2'
					, NOMINAL_LEMBUR = '$NOMINAL_LEMBUR', OUTLET = '$OUTLET', KODE_DIVISI = '$KODE_DIVISI', LINE = '$LINE', PENGAWAS = '$PENGAWAS' 
				...
				mysql_query("UPDATE pegawai SET NIP_PEGAWAI = '$NIP_PEGAWAI',NAMA_PEGAWAI = '$NAMA_PEGAWAI', TEMPAT_LAHIR = '$TEMPAT_LAHIR', TANGGAL_LAHIR = '$TANGGAL_LAHIR'
					, AGAMA = '$AGAMA', JUMLAH_ANAK = '$JUMLAH_ANAK', ALAMAT = '$ALAMAT', NOMOR_TELEPON = '$NOMOR_TELEPON', KODE_JABATAN = '$KODE_JABATAN'
					, KODE_DEPARTEMEN = '$KODE_DEPARTEMEN', GAJI_POKOK = '$GAJI_POKOK', TANGGAL_MASUK = '$TANGGAL_MASUK', TANGGAL_KELUAR = '$TANGGAL_KELUAR'
					, STATUS_PEGAWAI = '$STATUS_PEGAWAI', JENIS_KELAMIN = '$JENIS_KELAMIN', EMAIL = '$EMAIL', NO_REKENING = '$NO_REKENING', STATE_ID = '$STATE_ID',
					NOMINAL_UMT = '$NOMINAL_UMT', TABUNGAN = '$TABUNGAN', PENGHARGAAN = '$PENGHARGAAN', CATATAN = '$CATATAN', TUNJANGAN_LAIN = '$tmptunjanganlain2', 
					NOMINAL_LEMBUR = '$NOMINAL_LEMBUR', OUTLET = '$OUTLET', KODE_DIVISI = '$KODE_DIVISI', LINE = '$LINE', PENGAWAS = '$PENGAWAS'  
					WHERE KODE_PEGAWAI = '$KODE_PEGAWAI' ");
				include "../../include/catat.php";
				$user=$_SESSION['KODE_PETUGAS'];
