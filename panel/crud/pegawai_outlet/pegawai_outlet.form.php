...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#NIP_PEGAWAI").change(function () {
			...
			if (NIP_PEGAWAI == '') {
				...
				$.ajax({
					url: "crud/pegawai_outlet/ceknip.php?uname="+NIP_PEGAWAI
				}).done(function( data ) {
 ...
 <form class="form-horizontal pegawai_outletForm" id="pegawai_outletForm" action="crud/pegawai_outlet/pegawai_outlet.input.php" type="POST">
...
function getdivisi(){
	...
	//alert(divisi);
	$.ajax({
        url: "crud/pegawai_outlet/ambildivisi.php",
        data: {divisi: divisi},
        cache: false,
		 type: 'POST',
...
function getjabatan(){
	...
	//alert(jabatan);
	$.ajax({
        url: "crud/pegawai_outlet/ambiljabatan.php",
		...
		<div class="form-group">
            ...
            <div class="col-sm-9">
				...
				<input type="hidden" class="form-control" value="" id="LINE" name="LINE" \>
				<input type="hidden" class="form-control" value="" id="PENGAWAS" name="PENGAWAS" \>
			<input type="hidden" class="form-control" value="YA" id="OUTLET" name="OUTLET" \>
		...
		<div class="form-group">
            ...
            <div class="col-sm-9">
				<select name="STATUS_PEGAWAI" class="form-control" id="STATUS_PEGAWAI" style="width:100%">
					...
					<option value="Tetap" <?php if($STATUS_PEGAWAI=="Tetap"){echo "selected='selected'";}?>>1.Bulanan (Outlet)</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datePicker1').datepicker({
            ...
            $('#pegawai_outletForm').formValidation('revalidateField', 'TANGGAL_MASUK');
        });
		...
		.find('[name="TUNJANGAN_LAIN[]"]')
            ...
            .change(function(e) {
                $('#pegawai_outletForm').formValidation('revalidateField', 'TUNJANGAN_LAIN[]');
            })
            .end()
		.on('success.form.fv', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#dialog-pegawai_outlet').modal('hide');
					//alert(data);
                }
            });
        })
