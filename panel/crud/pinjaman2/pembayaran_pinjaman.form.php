...
<div class="col-md-12">
 ...
 <form class="form-horizontal pinjaman2Form" id="pinjaman2Form" action="crud/pinjaman2/bayar_pinjaman.input.php" type="POST">
    <div class="modal-body">
        ...
        <div class="form-group">
            <label for="NOMINAL_PEMBAYARAN" class="col-sm-3 control-label">Nominal Dibayar</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="NOMINAL_PEMBAYARAN" name="NOMINAL_PEMBAYARAN" value="<?php echo $CICILAN_PERBULAN; ?>" placeholder="Nominal" readonly/>
            </div>
		</div>
