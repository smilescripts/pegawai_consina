...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#NIP_PEGAWAI").change(function () {
			...
			if (NIP_PEGAWAI == '') {
				...
				$.ajax({
					url: "crud/pegawai_bekasi/ceknip.php?uname="+NIP_PEGAWAI
				}).done(function( data ) {
 ...
 <form class="form-horizontal pegawai_bekasiForm" id="pegawai_bekasiForm" action="crud/pegawai_bekasi/pegawai_bekasi.input.php" type="POST">
    <div class="modal-body">
		...
		<div class="form-group">
            ...
            <div class="col-sm-9">
				 ...
				 <?php
                    $resultgrade = mysql_query("select * from grade_bekasi");  
		...
		<div class="form-group">
            ...
            <div class="col-sm-9">
				<select name="STATUS_PEGAWAI" class="form-control" id="STATUS_PEGAWAI" style="width:100%">
					...
					<option value="Kontrak Bekasi" <?php if($STATUS_PEGAWAI=="Kontrak Bekasi"){echo "selected='selected'";}?>>1.Harian (Bekasi)</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datePicker1').datepicker({
            ...
            $('#pegawai_bekasiForm').formValidation('revalidateField', 'TANGGAL_MASUK');
        });
		...
		.find('[name="TUNJANGAN_LAIN[]"]')
            ...
            .change(function(e) {
                $('#pegawai_bekasiForm').formValidation('revalidateField', 'TUNJANGAN_LAIN[]');
            })
            .end()
