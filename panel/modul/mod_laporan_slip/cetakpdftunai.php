...
include "../../include/catat.php";
	...
	$aksi="Mengakses halaman cetak pdf data penggajian karyawan harian";
	catat($user,$aksi);
//============================================================+
...
$pdf->writeHTMLCell(0, 0, 50, 30,"Data Payroll Sewing & Helper Jakarta (Cash)", 0, 1, 0, true, '', true);
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('Data Payroll Sewing & Helper Jakarta (Cash)-'.$BULAN.'-'.$TAHUN.'.pdf', 'I');
