<?php
	...
	$aksi="Mengakses halaman master penggajian karyawan harian";
	catat($user,$aksi);
?>
<script>
...
<ol class="breadcrumb">
  ...
  <li class="active"><span class="glyphicon glyphicon-user"> input penggajian bekasi</li>
</ol>
...
<div class="panel panel-warning">
	   ...
	   <h1 class="headingtable" style="margin-top:0px" ><span>Penggajian</span> Pegawai Harian(Bekasi)</h1>
	
    <div class="panel-body">
		<div class="well">
			<form class="form-inline" id="input_penggajian_bekasiForm" action="crud/input_penggajian_bekasi/input_penggajian_bekasi.input.php" type="POST">
...
var audio = document.getElementById('audio');
    ...
    $(document).ready(function() {
			$('.input-daterange').datepicker({
						...
						$('#input_penggajian_bekasiForm').formValidation('revalidateField', 'end');
					});
						
	$('#input_penggajian_bekasiForm')
		...
		.on('success.form.fv', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
					...
					if(tipe=="CETAK"){
						//alert("Hanya Cetak");
						window.open('modul/mod_input_penggajian_bekasi/cetakpdf.php?dept='+departemen);
					
					}
					if(tipe=="CETAKSIMPAN"){
						//alert("Hanya Cetak");
						window.open('modul/mod_input_penggajian_bekasi/cetaksimpanpdf.php?dept='+departemen);
