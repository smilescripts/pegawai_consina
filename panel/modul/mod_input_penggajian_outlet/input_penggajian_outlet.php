<?php
	...
	$aksi="Mengakses halaman master penggajian karyawan bulanan Outlet";
	catat($user,$aksi);
?>
<script>
...
<div class="panel panel-warning">
    ...
    <div class="panel-body">
        ...
        <div class="well">
			<form class="form-inline" id="input_penggajian_outletForm" action="crud/input_penggajian_outlet/input_penggajian_outlet.input.php" type="POST">
				<div class="col-sm-6">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		$('.input-daterange').datepicker({
						...
						$('#input_penggajian_outletForm').formValidation('revalidateField', 'end');
					});
		
		$('#input_penggajian_outletForm')
		...
		.on('success.form.fv', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
					...
					if(tipe=="CETAK"){
						//alert("Hanya Cetak");
						window.open('modul/mod_input_penggajian_outlet/cetakpdf.php?dept='+departemen);
					
					}
					if(tipe=="CETAKSIMPAN"){
						//alert("Hanya Cetak");
						window.open('modul/mod_input_penggajian_outlet/cetaksimpanpdf.php?dept='+departemen);
