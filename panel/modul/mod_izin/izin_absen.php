<?php
	...
	$aksi="Mengakses halaman master Izin Absen";
	catat($user,$aksi);
?>
<script>
...
<div class="modal fade" id="dialog-izin_absen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h3 id="myModalLabel">Tambah Data Pengajuan izin absen</h3>
      </div>
...
<script src="crud/izin_absen/aplikasi.js"></script>
