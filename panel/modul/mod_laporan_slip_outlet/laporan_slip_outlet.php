...
<div class="panel panel-warning" id="non-printable" style="width:1300px;margin-left:-100px">
  <h1 class="headingtable" style="margin-top:0px" ><span>Laporan</span> Gaji Karyawan Bulanan (Counter)</h1>
    ...
    <div class="panel-body" >
		<div class="well">
            <form class="form-horizontal laporan_slip_outletForm" id="laporan_slip_outletForm" action="modul/mod_laporan_slip_outlet/laporan_slip_outlet.php" type="POST">
					...
					.on('success.form.fv', function(e) {
						...
						$.ajax({
							...
							success: function(data) {
								...
								$.get("modul/mod_laporan_slip_outlet/laporan.php?BULAN="+BULAN+"&TAHUN="+TAHUN+"&DEPT="+DEPT+"&NIP_PEGAWAIH="+NIP_PEGAWAIH, function(data){
									$('#laporan').html(data);
...
<div class="panel panel-warning" style="width:1300px;margin-left:-100px">
  <h1 class="headingtable" style="margin-top:0px" ><span>Data</span> Laporan Gaji Karyawan Bulanan (Counter)</h1>
	...
	<center>
		...
		<div id="data-laporan_slip_outlet" id="non-printable">
