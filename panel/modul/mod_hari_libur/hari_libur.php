<?php
	...
	$aksi="Mengakses halaman master hari libur";
	catat($user,$aksi);
?>
<script>
...
<ol class="breadcrumb">
  ...
  <li class="active"><span class="glyphicon glyphicon-user">Hari Libur</li>
</ol>



<div class="panel panel-warning">
      <h1 class="headingtable" style="margin-top:0px" ><span>Data</span> Hari Libur</h1>
    <div class="btnbantuan" style="margin-top:-55px;">
						 <a href="#dialog-hari_libur" id="0" class="btn tambah-hari_libur btn-danger" data-toggle="modal" >Tambah Data</a> 
							</div>
