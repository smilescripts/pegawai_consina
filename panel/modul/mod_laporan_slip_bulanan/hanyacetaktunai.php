<table id="example" class="table table-bordered" border="1">
	...
	<?php
		...
		where head_penggajian.format='Bulanan' and head_penggajian.bulan='$BULAN' and head_penggajian.tahun='$TAHUN' and (pegawai.NO_REKENING='' or pegawai.NO_REKENING IS NULL)") or die (mysql_error());
        $no = 0;
