...
<div class="panel panel-warning" id="non-printable" style="width:1300px;margin-left:-100px">
  <h1 class="headingtable" style="margin-top:0px" ><span>Laporan</span> Gaji Karyawan Bulanan (Buaran)</h1>
    ...
    <div class="panel-body" >
		<div class="well">
            <form class="form-horizontal laporan_slip_bulananForm" id="laporan_slip_bulananForm" action="modul/mod_laporan_slip_bulanan/laporan_slip_bulanan.php" type="POST">
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					$('#datePicker').datepicker({
						...
						$('#laporan_slip_bulananForm').formValidation('revalidateField', 'TAHUN');
					});
					$('#datePicker1').datepicker({
						...
						// Revalidate the date field
						$('#laporan_slip_bulananForm').formValidation('revalidateField', 'BULAN');
					});
					
					$('#laporan_slip_bulananForm')
					...
					.on('success.form.fv', function(e) {
						...
						$.ajax({
							...
							success: function(data) {
								...
								$.get("modul/mod_laporan_slip_bulanan/laporan.php?BULAN="+BULAN+"&TAHUN="+TAHUN+"&DEPT="+DEPT+"&NIP_PEGAWAIH="+NIP_PEGAWAIH, function(data){
									$('#laporan').html(data);
...
<div class="panel panel-warning" style="width:1300px;margin-left:-100px">
  <h1 class="headingtable" style="margin-top:0px" ><span>Data</span> Laporan Gaji Karyawan Bulanan (Buaran)</h1>
	...
	<center>
		...
		<div id="data-laporan_slip_bulanan" id="non-printable">
