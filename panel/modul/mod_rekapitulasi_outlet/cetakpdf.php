...
include "../../include/catat.php";
	...
	$aksi="Mengakses halaman cetak pdf data penggajian karyawan bulanan";
	catat($user,$aksi);
//============================================================+
...
$pdf->writeHTMLCell(0, 0, 70, 30,"Data Penggajian Pegawai Bulanan", 0, 1, 0, true, '', true);
$pdf->writeHTMLCell(0, 0, '', 40, $msg, 0, 1, 0, true, '', true);
