		...
		<div class="well">
			...
			$(document).ready(function() {
				...
				$('.input-daterange').datepicker({
						...
						$('#rekapitulasi_outletForm').formValidation('revalidateField', 'end');
					});
					
					$('#rekapitulasi_outletForm')
					...
					.on('success.form.fv', function(e) {
						...
						$.ajax({
							...
							success: function(data) {
								...
								$.get("modul/mod_rekapitulasi_outlet/laporan.php?start="+start+"&end="+end+"&DEPT="+DEPT+"&NIP_PEGAWAIH="+NIP_PEGAWAIH, function(data){
...
<div class="panel panel-warning">
	...
	<center>
		...
		<div id="data-rekapitulasi_outlet" id="non-printable">
