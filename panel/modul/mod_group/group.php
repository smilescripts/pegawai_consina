<?php
	...
	$aksi="Mengakses halaman master group pengguna";
	catat($user,$aksi);
?>
<script>
...
<div class="panel panel-warning">
    <h1 class="headingtable" style="margin-top:0px" ><span>Data</span> Group Manajemen Pengguna</h1>
    <div class="btnbantuan" style="margin-top:-55px;">
						 <a href="#dialog-group" id="0" class="btn tambah-group btn-danger" data-toggle="modal" >Tambah Data</a> 
							</div>
