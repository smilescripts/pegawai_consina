...
while ($minggu != $dateakhirnya);   
		...
		if($DEPT!="all" && $NIP_PEGAWAIH==""){
			$query=mysql_query("SELECT * FROM pegawai where KODE_DEPARTEMEN='$DEPT' and (STATUS_PEGAWAI='Kontrak Bekasi' and STATUS_PEGAWAI!='Keluar') and STATE_ID='$_SESSION[STATE_ID]'") or die (mysql_error());
		}
...
/* ------------------Fungsi mangkir-------------------- */
	...
	<center><h3><u>REKAPITULASI ABSENSI KEHADIRAN KARYAWAN HARIAN(BEKASI)</u></h3><h3><?php echo $namabulan;?> <?php echo $TAHUN;?></h3></center>
