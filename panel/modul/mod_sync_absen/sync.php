<?php
	...
	$getmachine=mysql_query("select * from mesin_absensi where KODE_MESIN='$KODE_MESIN'");
			...
			<table id="example" class="table table-bordered">
				...
				<tbody>
					<tr>
						...
						?>
						<td id="data-syncA" class="data-syncA"><b style="color:green;">Connected</b></td>
						<?php
								...
								if($zk !=""){
									...
									$zk->enableDevice();
									$zk->disconnect();
									echo '<script>$(".data-syncA").html("'.$jmldatamsk.'-Sync Masuk And '.$jmldataklr.'-Sync Keluar And '.$jmldl.'-Duplicated").show();</script>';
								}
							}
						?>
					</tr>
