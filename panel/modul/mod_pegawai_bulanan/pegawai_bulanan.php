...
<div class="panel panel-warning">
  <h1 class="headingtable" style="margin-top:0px" ><span>Data</span> Pegawai Harian (bulanan)</h1>
    ...
    <div class="panel-body">
        ...
        <div class="well">
            <div id="data-pegawai_bulanan"></div>
			
		</div>
    </div>
</div>

<div class="modal fade" id="dialog-pegawai_bulanan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script src="crud/pegawai_bulanan/aplikasi.js"></script>
