...
<div class="panel panel-warning" id="non-printable">
   <h1 class="headingtable" style="margin-top:0px" ><span>Rekapitulasi</span> gaji dan kehadiran karyawan Harian (Bekasi)</h1>
    <div class="panel-body" >
		<div class="well">
            <form class="form-horizontal rekapitulasi_harian_bekasiForm" id="rekapitulasi_harian_bekasiForm" action="modul/mod_rekapitulasi_harian_bekasi/laporan_slip_harian_bekasi.php" type="POST">
				<div class="form-group">
				<div class="col-sm-3">
					 <?php
                   
					$result=mysql_query("SELECT * FROM pegawai where (STATUS_PEGAWAI='Kontrak Bekasi' and STATUS_PEGAWAI!='Keluar')") or die (mysql_error());
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					$('.input-daterange').datepicker({
						...
						$('#rekapitulasi_harian_bekasiForm').formValidation('revalidateField', 'end');
					});
				
					$('#rekapitulasi_harian_bekasiForm')
