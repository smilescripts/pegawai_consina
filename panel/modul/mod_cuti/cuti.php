...
<div class="panel panel-warning">
	 <h1 class="headingtable" style="margin-top:0px" ><span>Data</span> Cuti</h1>
			<div class="btnbantuan" style="margin-top: -55px;">
							<a href="#dialog-cuti" id="0" class="btn tambah-cuti btn-danger" data-toggle="modal" ><i class="glyphicon glyphicon-plus-sign"></i>Tambah Data</a>
							</div>
