			...
			<div class="panel price panel-blue">
				...
				<ul class="list-group list-group-flush">
					<li class="list-group-item">
						PENERIMAAN : <span style="color:blue;">Rp. <?php echo number_format($total_penerimaan); ?>,-</span>
					</li>
					<li class="list-group-item">
						<ul>
							<li>Gaji Bulan Ini : <span style="color:blue;">Rp. <?php echo number_format($totalgaji);?>,-</span></li>
							<?php
							...
							<li>Lembur(<?php echo $totaljamlembur;?> Jam) : <span style="color:blue;">Rp. <?php echo number_format($totallembur);?>,-</span></li>
					...
					<li class="list-group-item">
						TAKE HOME PAY : <span style="color:blue;">Rp. <?php echo number_format($takehomepayfix); ?>,-</span>
					</li>
				</ul>
			</div>